<?php
     ...
     $sql1="SELECT news_id,news_name,news_detail,news_date,teacher.teacher_fname,teacher.teacher_lname 
     FROM news 
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title font-color" id="staticBackdropLabel" > เพิ่มข้อมูลข่าวสาร</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form class="row g-3 needs-validation" novalidate action="./Add/innews.php" method="POST">
                      <div >
                            <label for="validationCustom01" class="form-label" >ชื่อเรื่อง</label>
                            <input type="text" class="form-control" id="validationCustom01" placeholder="ชื่อเรื่อง" required name="news_name">
                          </div>
                          <div >
                        <div >
                            <label for="validationCustom01" class="form-label" >รายละเอียดข่าว</label>
                            <!-- <input type="text" class="form-control" id="validationCustom01" placeholder="รายละเอียดข่าว" required name="news_detail"> -->
                            <textarea class="form-control" required name="news_detail" cols="10" rows="10" style="font-family: 'Kanit', sans-serif;"></textarea>
                          </div>
                          <div >
                            <label for="validationCustom01" class="form-label" >ชื่อผู้ใช้(username)</label>
                            <input type="text" class="form-control" id="validationCustom01" required name="teacher_username" value="<?php echo $username?>" readonly/>
                          </div>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td data-label="รายวิชา"><?php echo $row['news_name']?></td>
                  <td data-label="ชื่อไลฟ์"><?php echo $row['news_detail']?></td>
                  <td data-label="ชื่อไลฟ์"><?php echo $row['news_date']?></td>
                  <td data-label="ชื่อไลฟ์"><?php echo $row['teacher_fname'].' '.$row['teacher_lname']?></td>
                  <td>
                  <button type="button" name="edit"  id="<?php echo $row["news_id"]; ?>" class="btn btn-info btn-xs edit_data"><i class='fas fa-edit'></i></button>
            </td>  
            <td>
                  <button type="button" name="view" value="view" data-bs-target="#staticBackdrop" id="<?php echo $row["news_id"]; ?>" class="btn btn-info btn-xs view_data"><i class='far fa-eye'></i></button>
            </td>   
        </td>
                </tr>
                <?php } ?>
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title"  id="staticBackdropLabel">ตารางแสดงข้อมูลข่าวสาร</h4>  
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>  
 ...
 <div id="dataModal1" class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <!-- <button type="button" class="close" data-dismiss="modal">&times;</button>   -->
                     <h4 class="modal-title"  id="staticBackdropLabel">แก้ไขข้อมูลข่าวสาร</h4>  
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>  
