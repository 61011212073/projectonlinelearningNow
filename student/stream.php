                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title font-color" id="staticBackdropLabel" > ข้อมูลไลฟ์สตรีม</h5>
                    ...
                    <div class="modal-body">
                      <form class="row g-3 needs-validation" novalidate>
                        ...
                        <div >
                            <label for="validationCustom01" class="form-label" >ชื่อไลฟ์สตรีม</label>
                          ...
                          <div >
                          <label for="formFile" class="form-label">ไฟล์ไลฟ์สตรีม</label>
...
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">ชื่อไลฟ์สตรีม</th>
      
      <th scope="col">วันที่และเวลา</th>
      <th scope="col">หน้าไลฟ์</th>
  ...
  <tbody>
    <tr>
      ...
      <td>
          ...
          <a class="btn btn-primary" href="seestream.php" role="button"> <i class="fa fa-video"></i></a>
...
<div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel1" aria-hidden="true">
  <div class="modal-dialog  modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel1">ตรงนี้ใส่สตรีม</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
      ...
      <i class="fa fa-edit"></i>
              ...
              <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel2" aria-hidden="true" >
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title font-color" id="staticBackdropLabel2" > ข้อมูลสื่อประกอบการสอน</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form class="row g-3 needs-validation" novalidate>
                        ...
                        <div >
                            <label for="validationCustom01" class="form-label" >ชื่อไลฟ์สตรีม</label>
                            <input type="text" class="form-control" id="validationCustom01" placeholder="กรอกชื่อไลฟ์สตรีม" required>
                            <div class="valid-feedback">
                              Looks good!
                            </div>
                          </div>
                          <div >
                            <label for="validationCustom01" class="form-label" >ลิงก์ไลฟ์สตรีม</label>
                            <input type="text" class="form-control" id="validationCustom01" placeholder="กรอกลิงก์ไลฟ์สตรีม" required>
                            <div class="valid-feedback">
                              Looks good!
                            </div>
                          </div>
