	...
	<div class="container">	
        <div class="row">
        	<div class="col-lg-4 col-md-6">
              ...
              <div class="icon_box text-center bg-white icon_box_style2 box_shadow2 radius_all_10 box_counter counter_style1 text-center " data-animation="fadeInUp" data-animation-delay="0.00s">
                            <div class="counter_icon box_icon bg_danger ">
                            <img src="assets2/images/students1.png" alt="book" />
                            </div>
                            <div class="counter_content">
                                <h3 class="counter_text"><span class="counter">200</span></h3>
                                <div class="intro_desc">
                                <h5 style="font-family: 'Kanit', sans-serif;">จำนวนนิสิตในรายวิชา</h5>
                            </div>
                            </div>
                        </div>
                    <div class="team_single_info">
                        <div class="team_name">
                            <h5>อาจารย์ประจำวิชา</h5>
                            <span>ผู้ช่วยศาสตราจารย์ จันทิมา พลพินิจ</span><br>
                            <span>ภาควิชาวิทยาการคอมพิวเตอร์ </span>
                        </div>
                        <h6 class="mb-3">ข้อมูลติดต่อ:</h6>
            ...
            <div class="col-lg-8 col-md-6">
            	<div class="teacher_desc mt-4 mt-md-0">
                    <h5 class="mb-3">คำอธิบายเกี่ยวกับรายวิชา</h5>
                    <p>ความรู้เบื้องต้นเกี่ยวกับเทคโนโลยีสารสนเทศทั้งระบบ ระบบคอมพิวเตอร์และเครือข่ายอัลกอริทึมและการโปรแกรม ระบบซอฟต์แวร์ทั้งระบบเดี่ยวและเครือข่ายขนาดใหญ่ ระบบซอฟต์แวร์สำหรับองค์การขนาดใหญ่ มือถือ ระบบฝังตัว</p>
                    <p>Introduction to an overall system of information technology; computer systems and networks;algorithm and programming; software application for homogeneous and heterogeneous system,
and enterprisesoftware; mobile application; and embedded systems</p>
                </div>
