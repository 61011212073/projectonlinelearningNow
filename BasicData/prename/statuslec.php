    ...
    //        <table class="table table-bordered">';  
      ...
      {  
          if ($row['preName_status'] == "1") {
           ...
           $output .= '  
                <form class="row g-3 needs-validation" novalidate action="../teacher/Edit/Editstatus/editpre_status.php" method="post">
                        <div>
                       ...
                       <div>
                              ...
                              <input type="text" class="form-control th" id="validationCustom01" placeholder="กรอกคำนำหน้าชื่อ" required name="prename" value="'.$row["preName_name"].'" readonly/>
                        </div>
                        <div>
